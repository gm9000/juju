...
public class UploadVideo2Activity extends BaseActivity  {
...
//                            mediaProcessService.stopEncoding();
//                            dialog.dismiss();
//                            ActivityUtil.finish(UploadVideo2Activity.this);
//                        }
//                    });
...
//
//                //设置PictureSize
//                Camera.Size pictureSize = getPropPictureSize(parameters.getSupportedPictureSizes(), previewRate, 320);
//                parameters.setPictureSize(pictureSize.width, pictureSize.height);
//
//                //设置PreviewSize
//                Camera.Size previewSize = getPropPreviewSize(parameters.getSupportedPreviewSizes(), previewRate, 320);
...
//
//
//                        UploadVideo2Activity.this.runOnUiThread(new Runnable() {
//                            @Override
//                            public void run() {
...
//            mediaProcessService.setContext(UploadVideo2Activity.this);
