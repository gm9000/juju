package com.juju.app.media.rtmp.amf;
...
public class AmfString implements AmfData {
    ...
    public void writeTo(OutputStream out) throws IOException {
        ...
        RtmpUtil.writeUnsignedInt16(out, byteValue.length);
        // Write string
        out.write(byteValue);
    }
    ...
    public void readFrom(InputStream in) throws IOException {
        ...
        int length = RtmpUtil.readUnsignedInt16(in);
        size = 3 + length; // 1 + 2 + length
        // Read string value
        byte[] byteValue = new byte[length];
        RtmpUtil.readBytesUntilFull(in, byteValue);
