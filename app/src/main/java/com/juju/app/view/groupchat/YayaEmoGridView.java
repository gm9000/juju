...
import com.juju.app.adapter.YayaEmoGridViewAdapter;
...
public class YayaEmoGridView extends LinearLayout {
    ...
    private int[] getGridViewData(int index) {
        ++index;
        int startPos = (index - 1) * Constants.yayaPageSize;
        int endPos = index * Constants.yayaPageSize - 1;
    ...
    private GridView getViewPagerItem(final int index) {
        ...
        gridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                int start = index * Constants.yayaPageSize;
