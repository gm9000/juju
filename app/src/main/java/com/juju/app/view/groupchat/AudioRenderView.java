...
public class AudioRenderView extends  BaseMsgRenderView {
    ...
    @Override
    public void render(final MessageEntity messageEntity, final User userEntity, final Context ctx) {
        ...
        if (null != audioPath) {
            ...
            if(width< ScreenUtil.dip2px(ctx, 45))
            {
                width = ScreenUtil.dip2px(ctx, 45);
            }
