...
import com.juju.app.adapter.EmoGridViewAdapter;
import com.juju.app.adapter.ViewPageAdapter;
...
//                     20, 20);
    ...
    private int[] getGridViewData(int index) {
        ++index;
        int startPos = (index - 1) * (Constants.pageSize - 1);
        int endPos = index * (Constants.pageSize - 1);
        int length = 0;
        ...
        if (length > 1)
            tmps[length - 1] = R.mipmap.tt_default_emo_back_normal;
        return tmps;
    }
    ...
    private GridView getViewPagerItem(final int index) {
        ...
        gridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                int start = index * (Constants.pageSize - 1);
