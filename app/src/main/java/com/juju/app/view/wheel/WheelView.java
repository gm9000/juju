...
import com.juju.app.utils.SizeConvertUtil;
...
public class WheelView extends View {
    ...
    private void init(Context context) {
        ...
        selectPaint.setColor(getResources().getColor(R.color.blue));
        ...
        centerLinePaint.setColor(getResources().getColor(R.color.gray));
