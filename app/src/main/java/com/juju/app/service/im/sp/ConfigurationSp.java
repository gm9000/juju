package com.juju.app.service.im.sp;
...
public class ConfigurationSp {
    ...
    public static ConfigurationSp instance(Context ctx, String loginId) {
        if (configurationSp == null
                || !configurationSp.loginId.equals(loginId)) {
    ...
    private ConfigurationSp(Context ctx, String loginId) {
        this.ctx = ctx;
