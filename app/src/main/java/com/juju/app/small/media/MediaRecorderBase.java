package com.juju.app.small.media;
...
public abstract class MediaRecorderBase implements Callback, PreviewCallback, IMediaRecorder {
	...
	private Logger logger = Logger.getLogger(MediaRecorderBase.class);
	...
	public boolean manualFocus(AutoFocusCallback cb, List<Area> focusAreas) {
		if (camera != null && focusAreas != null && mParameters != null && CameraUtil.hasICS()) {
			try {
				camera.cancelAutoFocus();
	...
	protected void prepareCameraParaments() {
		...
		if (!CameraUtil.isDevice("GT-N7100", "GT-I9308", "GT-I9300")) {
