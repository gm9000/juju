package com.juju.app.zxing.decoding;
...
import com.juju.app.activity.QrCaptureActivity;
import com.juju.app.zxing.ViewfinderResultPointCallback;
...
public final class QrCaptureActivityHandler extends Handler {
	...
	private static final String TAG = QrCaptureActivityHandler.class
			.getSimpleName();
	...
	public QrCaptureActivityHandler(QrCaptureActivity activity,
